    ...
    update(num) {
        if (this.pos != -1 && this.pos + num <= 56) {
            ...
            for (let i = this.pos; i < this.pos + num; i++) {
                this.path[i](this.color_id, this.Pid); console.log('Harsh Kale')
            }
            this.pos += num;
            if (this.pos == 56) {
                        ...
                        if (Xp - PLAYERS[myid].myPieces[i].x < 45 && Xp - PLAYERS[myid].myPieces[i].x > 0 && Yp - PLAYERS[myid].myPieces[i].y < 45 && Yp - PLAYERS[myid].myPieces[i].y > 0) {
                            ...
                            if ((spirit.includes(i) || num == 6) && PLAYERS[myid].myPieces[i].pos + num <= 56) {
                                ...
                                displayQuestion(function (isCorrect) {
                                    if (isCorrect) {  // Replace with the correct answer
...
const mcqQuestions = [
    {
        question: "Which of these schools was not among the early leaders in AI research?",
    ...
    {
        question: "DARPA, the agency that has funded a great deal of American AI research, is part of the Department of:",
        options: ["\na. Defense", "\nb. Energy", "\nc. Education", "\nd. Justice", "\ne. None of the above"],
        correctAnswer: "a"
    },
    {
    ...
    {
        question: "What of the following is considered to be a pivotal event in the history of AI.",
    ...
    {
        question: "A certain Professor at the Stanford University coined the word 'artificial intelligence' in 1956 at a conference held at Dartmouth College. Can you name the Professor?",
        options: ["\na. David Levy", "\nb. John McCarthy", "\nc. Joseph Weizenbaum", "\nd. Hans Berliner", "\ne. None of the above"],
        correctAnswer: "b"
    },
    {
    ...
    {
        question: "A.M. Turing developed a technique for determining whether a computer could or could not demonstrate artificial intelligence. Presently, this technique is called",
        options: ["\na. Turing Test", "\nb. Algorithm", "\nc. Boolean Algebra", "\nd. Logarithm", "\ne. None of the above"],
        correctAnswer: "a"
    },
    {
    ...
    {
        question: "Artificial Intelligence has its expansion in the following applications.",
        options: ["\na. Planning and Scheduling", "\nb. Game Playing", "\nc. Robotics", "\nd. All of the above"],
        correctAnswer: "d"
    },
    {
        question: "The characteristics of the computer system capable of thinking, reasoning, and learning are known as",
    ...
    {
        question: "______ is a branch of computer science that deals with helping machines find solutions to complex problems in a more human-like fashion.",
        options: ["\na. Artificial Intelligence", "\nb. Internet of Things", "\nc. Embedded System", "\nd. Cyber Security"],
        correctAnswer: "a"
    },
    {
        question: "In ____ the goal is for the software to use what it has learned in one area to solve problems in other areas.",
        options: ["\na. Machine Learning", "\nb. Deep Learning", "\nc. Neural Networks", "\nd. None of these"],
        correctAnswer: "b"
    },
    {
        question: "Computer programs that mimic the way the human brain processes information is called as",
        options: ["\na. Machine Learning", "\nb. Deep Learning", "\nc. Neural Networks", "\nd. None of these"],
        correctAnswer: "c"
    },
    {
        question: "A ____ is a rule of thumb, strategy, trick, simplification, or any other kind of device which drastically limits search for solutions in large problem spaces.",
        options: ["\na. Heuristic", "\nb. Critical", "\nc. Value based", "\nd. Analytical"],
        correctAnswer: "a"
    },
    {
    ...
    {
        question: "Aristotle’s theory of syllogism and Descartes and Kant’s critic of pure reasoning made knowledge on _____.",
        options: ["\na. Logic", "\nb. Computation logic", "\nc. Cognition logic", "\nd. All of above"],
        correctAnswer: "a"
    },
    {
    ...
    {
        question: "In 1960s, _____ pushed the logical formalism to integrate reasoning with knowledge.",
        options: ["\na. Marvin Minsky", "\nb. Alain Colmerauer", "\nc. John McCarthy", "\nd. None of above"],
        correctAnswer: "a"
    },
    {
        question: "Sensing organs as input, mechanical movement organs as output and central nervous system (CNS) in the brain as control and computing devices is known as _____ of human being",
        options: ["\na. Information Control Paradigm", "\nb. Information Processing Paradigm", "\nc. Information Processing Control", "\nd. None of above"],
        correctAnswer: "b"
    },
    {
        question: "_____ model was developed and incorporated in machines which mimicked the functionalities of human origin.",
        options: ["\na. Functional model", "\nb. Neural model", "\nc. Computational model", "\nd. None of above"],
        correctAnswer: "c"
    },
    {
        question: "Chomsky’s linguistic computational theory generated a model for syntactic analysis through ________",
    ...
    {
        question: "____ AI is a type of intelligence which could perform any intellectual task with efficiency like human.",
        options: ["\na. Narrow AI", "\nb. General AI", "\nc. Super AI", "\nd. None of above"],
        correctAnswer: "b"
    },
    {
        question: "The idea behind _________AI is to make such a system which could be smarter and think like a human by its own.",
        options: ["\na. Narrow AI", "\nb. General AI", "\nc. Super AI", "\nd. None of above"],
        correctAnswer: "b"
    },
    {
        question: "The worldwide researchers are now focusing on developing machines with ___ AI.",
        options: ["\na. Narrow AI", "\nb. General AI", "\nc. Super AI", "\nd. None of above"],
        correctAnswer: "b"
    }
];
